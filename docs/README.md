...
- `docs/architecture/CONFIGURATOR_V1_UI_FRAMEWORK.md` — documented guardrail of the accepted Configurator implementation; current UI/UX authority is the application on main
