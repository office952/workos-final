...
LETTERS Service/Labor recipes are functional V1. Canonical none/none EIC is 595.00 EUR PARTIAL because cost evidence is still in workshop calibration. Operator-confirmed FACE area and VOLUME perimeter are valid Product Truth. Analyzer handoff is deferred; it is not the current planned-EIC blocker. Values are calibratable development configuration, not final workshop rates.
