...
UI Foundation V1 is Owner-accepted (2026-09-16) as documentation / Figma direction. Runtime presentation is not accepted from that Figma decision. Living authority: `docs/architecture/WORKOS_UI_UX_DIRECTION_CANON.md`. This construction map is not the live V1 sequence.
...
| UI Foundation V1 (WorkOs-F) | OWNER_ACCEPTED / DOCUMENTATION_READY / FIGMA_READY / RUNTIME NOT IMPLEMENTED |
