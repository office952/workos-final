...
NEXT_RECOMMENDED_BUILD               = CHATGPT_INDEPENDENT_UI20_R5A_REVIEW
...
UI20_R4A                             = ACCEPTED
UI20_R5                              = NORTH_STAR_CONTINUITY_IN_REVIEW
...
R2 is `RESEARCH_ACCEPTED_WITH_ADVISORIES`. UI20-R3 is `CHARACTER_PROOF_ACCEPTED_WITH_ADVISORIES`. S1-A is the accepted structural base. UI20-R4 is `PAGE_PERSONALITY_AND_SEMANTIC_DYNAMICS_ACCEPTED_WITH_ADVISORIES`. UI20-R4A is `ACCEPTED`. UI20-R5 is `NORTH_STAR_CONTINUITY_IN_REVIEW`. G and IA-3 remain the leading direction, not Owner-accepted final visual direction or IA. The next recommended step is `CHATGPT_INDEPENDENT_UI20_R5A_REVIEW`.
