...
NEXT_RECOMMENDED_BUILD               = UI20_DL1_DESIGN_LANGUAGE_FOUNDATIONS
...
R2 is `RESEARCH_ACCEPTED_WITH_ADVISORIES`. UI20-R3 is `CHARACTER_PROOF_ACCEPTED_WITH_ADVISORIES`. S1-A is the accepted structural base. UI20-R4 is `PAGE_PERSONALITY_AND_SEMANTIC_DYNAMICS_ACCEPTED_WITH_ADVISORIES`. UI20-R4A is `ACCEPTED`. UI20-R5 is `DIRECTION_ACCEPTED_WITH_ADVISORIES`. G is `ACCEPTED_AS_UI20_LEADING_DIRECTION`. IA-3 is `ACCEPTED_AS_UI20_LEADING_IA`. Final visual direction and final IA remain not Owner-accepted. The next recommended step is `UI20_DL1_DESIGN_LANGUAGE_FOUNDATIONS`.
