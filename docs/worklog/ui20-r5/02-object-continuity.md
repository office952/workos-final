# UI20-R5 — Object continuity

ObjectRegister stays. IDs are not peers.

| Surface | Dominant | Lineage (quiet) | Surface change |
| --- | --- | --- | --- |
...
```text
OBJECT_REGISTER_CONTINUITY = PASS
LINEAGE_CONTINUITY = PASS
```

The object is the continuity anchor. The page does not animate as a whole across routes.
