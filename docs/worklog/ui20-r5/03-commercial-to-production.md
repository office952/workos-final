...
The R5 synthetic fixture continues from frozen OFT-221 to LUC-88 only because those downstream prerequisite facts are already represented separately. Figma therefore shows quiet provenance on frozen 1440 (`96:400`), frozen 1280 (`124:2`), and frozen 768 (`112:2`), then `Deschide lucrarea`. It does not add `Acceptă oferta`. It does not fake an Order write. `DIRECT_FREEZE_TO_LUCRARE = NO` at 1440, 1280, and 768.
