...
- OS-S1 is implemented on main. OS-S2 design is Owner-accepted. OS-S2 implementation and later slices require a separate Owner GO. This file does not authorize them.
