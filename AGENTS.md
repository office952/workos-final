...
Primary nav is Lucrări + Oferte + Produse + Administrare. `/` is the operational job overview. `/quotes` is the frozen-offer registry. Inspection surfaces live under Administrare. See `docs/architecture/UI_UX_FOUNDATION_CANON.md`.
